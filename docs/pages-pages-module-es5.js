...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-pages-module"], {
  ...
  function srcAppPagesModulesDashboardComponentsIdCCarouselIdCCarouselComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function IdCCarouselComponent_div_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    /*#__PURE__*/
    function () {
      function IdCCarouselComponent(translate) {
    ...
    IdCCarouselComponent.ɵfac = function IdCCarouselComponent_Factory(t) {
      return new (t || IdCCarouselComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__["TranslateService"]));
    };
    ...
    IdCCarouselComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 23,
      vars: 4,
      consts: [[1, "carrousel"], ["id", "slider"], ["checked", "", "type", "radio", "name", "slider", "id", "slide1"], ["type", "radio", "name", "slider", "id", "slide2"], ["type", "radio", "name", "slider", "id", "slide3"], ["type", "radio", "name", "slider", "id", "slide4"], ["id", "slides"], ["id", "overflow"], [1, "inner"], ["class", "slide", 4, "ngFor", "ngForOf"], ["id", "controls"], ["for", "slide1"], ["for", "slide2"], ["for", "slide3"], ["for", "slide4"], ["id", "bullets"], [1, "slide"], [1, "row", "name"], [1, "row", "description", 3, "innerHTML"], [1, "slide-content"], ["alt", "", 1, "img_slider", 3, "src"]],
